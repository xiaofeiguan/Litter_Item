...
@implementation GSHelpDetailViewController
...
-(void)setupNavi{
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"navigation_icon_back"] style:UIBarButtonItemStylePlain target:self action:@selector(back)];
...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler{
    ...
    if ([url hasPrefix:@"https://itunes.apple.com"]) {
        ...
        UIAlertView *alertView = [[UIAlertView alloc]initWithTitle:nil message:i18n(@"Jump to AppStore") delegate:self cancelButtonTitle:i18n(@"confirm") otherButtonTitles:i18n(@"cancel"), nil];
        [alertView show];
        //不允许跳转
